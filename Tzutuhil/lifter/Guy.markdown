...
But  are a man, and see only my pan,
...
N=1.	Trivially true, since both  and the elevator only have one
	floor to go to.

Assume true for N, prove for N+1:
	If  are on any of the first N floors, then it is true by the
	induction hypothesis.  If  are on the N+1st floor, then both 
...
the girl feels anything for  at all, 'll know.
...
A clean upstanding chap like ?
Sure, if r throat 'tis hard to slit,
Slit r girl's, and swing for it.
Like enough,  won't be glad,
When they come to hang , lad:
But bacon's not the only thing
That's cured by hanging from a string.
So, when the spilt ink of the night
Spreads o'er the blotting pad of light,
Lads whose job is still to do
Shall whet their knives, and think of .
		-- Hugh Kingsmill
...
-- Lew Col
It's not the fall that kills , it's the landing.
...
I want to marry a girl just like the girl that married ar old dad.
		-- Freud
How do  explain Wayne Newton's POWER over millions?  It's th' MOUSTACHE
...  Have  ever noticed th' way it radiates SINCERITY, HONESTY & WARMTH?
It's a MOUSTACHE  want to take HOME and introduce to NANCY SINATRA!
Never buy what  do not want because it is cheap; it will be ar to .
		-- Thomas Jefferson
...
You should go home.
Do  think r mother and I should have lived comfortably so long
...
Mommy, what happens to r files when  die?
You have a will that can be influenced by all with whom  come in contact.
...
Dear Miss Manners:
Please list some tactful ways of removing a man's saliva from r face.

Gentle Rear:
Please list some cent ways of acquiring a man's saliva on r face. If
the gentleman sprayed  inadvertently to accompany enthusiastic
discourse,  may step back two paces, bring out r handkerchief, and
go through the motions of wiping r nose, while trailing the cloth along
r face to pick up whatever needs mopping along the route.  If, however,
the substance was acquired as a result of enthusiasm of a more intimate
nature,  may licately retrieve it with a flick of r pink tongue.
...
sense from things she found in gift shops.
		-- Kurt Vonnegut, Jr.
If  think last Tuesday was a drag, wait till  see what happens tomorrow!
...
If  lived today as if it were r last, 'd buy up a box of rockets
and fire them all off, wouldn't ?
		-- Garrison Keillor
...
Eschew obfuscation.
Treat r friend as if he might become an enemy.
		-- Publilius Syrus
alimony, n:
...
Conceit causes more conversation than wit.
		-- LaRouchefoucauld
There is no such thing as a problem without a gift for  in its hands.
...
Cohn's Law:
	The more time  spend in reporting on what  are doing, the less
	time  have to do anything.  Stability is achieved when  spend
	all r time reporting on the nothing  are doing.
I sent a message to another time,
But as the days unwind -- this I just can't believe,
I sent a message to another plane,
Maybe it's all a game -- but this I just can't conceive.
...
I met someone who looks at lot like ,
She does the things  do, but she is an IBM.
...
She knows I think of , she reads my mind,
...
Never ask the barber if  need a haircut.
...
"Whom are ?" said he, for he had been to night school.
		-- George A
...
Hear about the ng Chinese woman who just won the lottery?
One fortunate cookie...
Anybody can win, unless there happens to be a second entry.
"I'm really enjoying not talking to  ... Let's not talk again ____REAL
soon ..."
...
Worrying is like rocking in a rocking chair -- It gives  something to do,
...
"The intical is equal to itself, since it is different."
		-- Franco Spisani
It doesn't matter what  do, it only matters what  say 've
done and what 're going to do.
University, n.:
	Like a software house, except the software's free, and it's usable,
	and it works, and if it breaks they'll quickly tell  how to fix
	it, and ...

	[Okay, okay, I'll leave it in, but I think 're stroying
...
Tact, n.:
	The unsaid part of what 're thinking.
...
power  have veloped, and terrified at the thought that so much hious
...
Give me a sleeping pill and tell me r troubles.
...
he continued, " can have the bedroom at the top of the stairs, to the
right."
...
electrons, that  cannot see with the naked eye unless  have been
...
homes is 110 volts per hour.  This is very fast.  In the time it has taken
 to read this sentence so far, an electron could have traveled all the
