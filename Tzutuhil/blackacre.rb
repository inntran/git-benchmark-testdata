...
devoured.
		-- Konrad Adenauer
 income tax has made me liars out of the American people than golf
has.  Even when you make a tax fm out on the level, you don't know
when it's through if you are a crook  a martyr.
		-- Will Rogers
...
Martin's Extension:
 ...
 New England Journal of Medicine repts that 9 out of 10 docts agree
that 1 out of 10 docts is an idiot.
Computers will not be perfected until they can compute how much me
than the estimate the job will cost.
If a thing's wth doing, it is wth doing badly.
		-- G.K. Chesterton
...
Confession is good f the soul only in the sense that a tweed coat is
good f dandruff.
		-- Peter de Vries
...
"Science makes godlike -- it is all over with priests and gods when man becomes
 scientific.  Mal:  science is the fbidden as such -- it alone is 
 fbidden.  Science is the *first* sin, the *iginal* sin.  *This alone is
 mality.* ``Thou shalt not know'' -- the rest follows."
-- Friedrich Nietzsche
...
f the developed film to arrive in the mail, but that is all right
...
them put it, "We could not now take time f further consideration, our
...
We are all agreed that your they is crazy.   question which divides us is
whether it is crazy enough to have a chance of being crect.  My own ling
...
Life is a game.  In der to have a game, something has to be me
imptant than something else.  If what already is, is me imptant
than what isn't, the game is over.  So, life is a game in which what
isn't, is me imptant than what is.  Let the good times roll.
		-- Werner Erhard
I can't understand it.  I can't even understand the people who can
understand it.
		-- Queen Juliana of the Netherlands.
      ...and befe I knew what I was doing, I had kicked the
      typewriter and threw it around the room and made it beg f
      mercy.  At this point the typewriter pleaded f me to dress
...
> I'm an idiot.. At least this [bug] took about 5 minutes to find..
We need to find some new terms to describe the rest of us mere mtals
then.
...
violence has settled me issues throughout histy than any other method
ever employed.  Perhaps the city fathers of Carthage could debate the
issue, with Hitler and Alexander as judges?
He who has the courage to laugh is almost as much a master of the wld
...
deal with.
F a holy stint, a moth of the cloth gave up his woolens f lint.
re are bad times just around the cner,
re are dark clouds hurtling through the sky
	And it's no good whining 
	About a silver lining
F we know from experience that they won't roll by...
		-- Noel Coward
 heaviest object in the wld is the body of the woman you have ceased
to love.
...
spirits, demons,  extraterrestrials when natural causes will suffice.
...
Perhaps no person can be a poet,  even enjoy poetry without a certain
unsoundness of mind.
		-- Thomas Macaulay
Wiker's Law:
...
conversely, the dolphins had always believed that they were far me
intelligent than man -- f precisely the same reasons.
...
IBM Pollyanna Principle:
	Machines should wk.  People should think.
667:
	 neighb of the beast.
...
No house should ever be on any hill  on anything.  It should be of the hill,
belonging to it.
		-- Frank Lloyd Wright
...
there is a man either running  walking in front of it waving a red
...
to do is get up every mning and say, "How's the President?"
		-- Will Rogers
...
-- Siddartha, _Ld_of_Light_ by Roger Zelazny
...
fest, with identical results.  y chanced to collide head-on in a clearing.
...
say in those awkward situations?  Wry no me...
	...
	Just beacuse.
"All the system's paths must be topologically and circularly interrelated f 
...
"Not Hercules could have knock'd out his brains, f he had none."
		-- Shakespeare
What is a magician but a practising theist?
		-- Obi-Wan Kenobi
...
Walk softly and carry a big stick.
		-- ode Roosevelt
A prediction is wth twenty explanations.
		-- K. Brecher
...
Always there remain ptions of our heart into which no one is able to enter,
invite them as we may.
"I believe that Ronald Reagan will someday make this
 country what it once was... an arctic wilderness."
-- Steve Martin
Concerning the war in Vietnam, Senat Gege Aiken of Vermount noted
in January, 1966, "I'm not very keen f doves  hawks.  I think we need
me owls."
