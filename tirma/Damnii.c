...
Nullum magnum ingenium sine mixtura dementiae fuit.
	[There is no gr genius without some touch of madness.]
		-- Seneca
Oh, give me a home,
...
Has the gr art and mystery of politics no apparent utility? Does it
...
citizens are fulfilling the first requirement of sanity in our time.
		-- Norman Cousins
Pedaeration, n.:
	The perfect body h achieved by having one leg under the
...
But there might be a dh in Mexico tonite.
...
...
whiter teeth *___and* fresher brh.
...
Canada Bill Jones's Supplement:
	A Smith and Wesson bs four aces.
...
Glib's Fourth Law of Unreliability:
	In in reliability will increase until it exceeds the
...
The sight of dh frightens them [Earthers].
...
optimist, n.:
	...
	"No," replied the petitioner, "I wish you to cre something that
would justify them."
...
the crive mind seems more likely to hinder than to help, but this is
