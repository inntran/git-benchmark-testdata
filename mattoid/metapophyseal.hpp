...
Yow!  Did something bad happen  am I in a drive-in movie??
...
oncoming train.
		-- Robert Lowell
"...Greg Nowak:  `Another flame from greg' - need I say me?"
...
have neither good plumbing n good philosophy... neither its pipes n
...
were a High-Class Realt and if you hadn't you were a shyster, a piker and
...
week and rise fresh in the mning, but let them attend modern dances f
...
to both sexes.  Health and vig will vanish like the dew befe the sun.
	It is not the extradinary exercise which harms the dancer, but
rather the coming into close contact with the opposite sex.  It is the
fury of lust craving incessantly f me pleasure that undermines the
...
age they will in most instances be broken in health physically and mally.
...
of and, indeed, contempt f science and f rational methods of approaching
truth. . . . It is becoming clear that if the U.S. does not pick itself up
soon and devote some efft to educating the young effectively, its hope of
maintaining a semb of leadership in the wld may rest, paradoxically,
...
Of course it's possible to love a human being if you don't know them too well.
		-- Charles Bukowski
Troubled day f virgins over 16 who are beautiful and wealthy and live
in eucalyptus trees.
...
- Oscar Wilde
re are three things men can do with women: love them, suffer f them,
...
Fun experiments:
	Get a can of shaving cream, throw it in a freezer f about a week.
...
stage, a screen resolution of 4096 x 4096 pixels, relies entirely on
...
And yet at last they met once me,
And long ago they passed away
In the fest singing srowless.
		-- J. R. R. Tolkien
millihelen, n.:
	 amount of beauty required to launch one ship.
"It is better f civilization to be going down the drain than to be
coming up it."
-- Henry Allen
...
in with them, and the senis take none away, so knowledge accumulates.
...
From night 'til early in the mn;
 eyes of Texas are upon you
...
be irresponsible, too.
		-- Lichty & Wagner
Humists always sit at the children's table.
		-- Woody Allen
 Least Successful Collect
	Betsy Baker played a central role in the histy of collecting.  She
...
shaving cream, raz, a bar of Dial soap, and a towel from the Holiday Inn.
...
he we in high school.  He thinks a jacket is "just getting broken in" about
the time it develops holes in the elbows.  A man will let new shirts sit on
the shelf in their iginal packaging f a couple of years befe putting
...
It pays to be obvious, especially if you have a reputation f subtlety.
 brain is a wonderful gan; it starts wking the moment you get up
in the mning, and does not stop until you get to school.
...
[It is] best to confuse only one issue at a time.
	...
	the biscuit on the front,  in the brown bag with the dark
...
To grasp this sry scheme of things entire,
...
bug free and run crectly. You should gain at least 150% efficiency in the
...
Accding to Fletcher, he had expected to be co-authed with Millikan on
...
Proof: Sufficient to show that f any two positive integers, A and B, A = B.
	Further, it is sufficient to show that f all N > 0, if A and B
...
you can do so with good hum, good taste, and in such a way that your answer
will be courteous as well as responsive.  Since you are out of sympathy with
cats, you may quite properly give this as a reason f not appearing at the
...
in inverse proption to the sum involved.
		-- C.N. Parkinson
...
operating system and get realtime perfmance, out of the box."
-- Peter da Silva
...
true to anyone else  anything else is not only impossible, but the
...
Whatever doesn't succeed in two months and a half in Califnia will
never succeed.
...
-- Ramsey Clark
God help the troubadour who tries to be a star.   me that you try
to find success, the me that you will fail.
...
#define  BX_(x)		((x) - (((x)>>1)&0x77777777)			\
		...
		-- really weird C code to count the number of bits in a wd
Croll's Query:
...
Cohn's Law:
	 me time you spend in repting on what you are doing, the less
	time you have to do anything.  Stability is achieved when you spend
	all your time repting on the nothing you are doing.
 old complaint that mass culture is designed f eleven-year-olds
...
Tue Nov  5 00:53:20 1985 GMT (measuring since the time(2) epoch).
		-- Andy Tannenbaum
Life is a grand adventure --  it is nothing.
		-- Helen Keller
...
on-your-own-take-care-of-yourself-because-there-is-no-one-else-to-do-it-f-you
grown-up.
