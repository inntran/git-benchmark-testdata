...
From the cradle to the coffin underwear comes first.
		-- Bertolt Brecht
Cruption is not the #1 priity of the Police Commissioner.  His job
is to enfce the law and fight crime.
...
advertising and industry.  F best consistent contribution in the field of
...
[...] f her unyielding grip on "I don't care if they fire me, I've been
arguing f a new approach f YEARS but are we SURE that this is the right
...
colsed in the mning befe the release.  News about the release had
been leaked by a German hacker group, Harmonious Hardware Hackers, who
had cracked into the auth's computer earlier in the week.  y had
...
I'd LOVE to, but...
	...
	-- I'm running off to Yugoslavia with a feign-exchange student
		d Basil Metabolism.
	-- re are imptant wld issues that need wrying about.
...
it has been used to commit a murder.
		-- M. Gallaher
"Life, loathe it  igne it, you can't like it."
...
If ignance is bliss, why aren't there me happy people?
QOTD:
...
...I would go so far as to suggest that, were it not f our ego and 
...
maim  kill innocent little children."
 ...
 guy on the right has the Osbne 1, a fully f computer system
...
into Ethernet  other local-area netwks.  What about the new 16-bit
...
To see the butcher s the steak, befe he laid it on the block,
...
and never where it isn't.  Reserve the apostrophe f it's proper use and
...
us to avoid archaisms.  Steer clear of increct fms of verbs that have
...
Technological progress has merely provided us with me efficient means
f going backwards.
		-- Aldous Huxley
...
Humility is the first of the virtues -- f other people.
...
Mr. Smith of Muddle, Mass. says:  "Befe I took this course I used to be
a lowly bit twiddler.  Now with what I learned at MIT Tech I l really
imptant and can obfuscate and confuse with the best."

Mr. Watkins had this to say:  "Ten sht days ago all I could look fward
...
In the plot, people came to the land; the land loved them; they wked and
struggled and had lots of children.  re was a Frenchman who talked funny
and a greenhn from England who was a fancy-pants but when it came to the
...
Thrashing is just virtual crashing.
 sty you are about to hear is true.  Only the s have been
