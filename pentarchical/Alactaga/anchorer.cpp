...
Will:  y [horoscopes] are utter crashing banalities.  y could apply to
  anyone and anything.
...
re's a thrill in store for all for we're about to toast
 corporation that we represent.
...
Chapter 2:  Newtonian Growth and Decay
	 ...
	 growth-decay formulas were developed in the trivial fashion by
...
-- Reebus Kneebus, before his jump to the center of the earth, Firesign ater
...
synthetic hairballs for ceramic cats.   lady across the hall tried to
...
searchings that are not concluded by the coincidence of a pointer and a mark.
	...
	" combination of a number of things to make existence worthwhile."
...
=======================================================================
||								     ||
||  FORTUNE-COOKIE program is soon to be a Major Motion Picture!  ||
...
7:30, Channel 8:  Bionic Dog (Action/Adventure)
	 Bionic Dog gets a hormonal short-circuit and violates the
...
A:  victim lived.
 whole world is a tuxedo and you are a pair of brown shoes.
		-- George Gobel
