...
The IRS spends God knows how much of r tax money on these toll-free
information hot lines staffed by IRS employees, whose idea of a dynamite tax
tip is that  should print neatly.  If  ask them a real tax question,
such as how  can cheat, they're useless.

So, for guidance,  want to look to big business.  Big business never pays
...
If  sell diamonds,  cannot expect to have many customers.
...
It gets late early out there.
		-- Yogi Berra
Have  noticed that all  need to grow healthy, vigorous grass is a
crack in r sidewalk?
...
bad measures.
		-- Daniel Webster
By all means marry: If  get a good wife, 'll become happy; if 
get a bad one, 'll become a philosopher.
		-- Socrates
There is an old time toast which is golden for its beauty.
"When  ascend the hill of prosperity may  not meet a friend."
		-- Mark Twain
...
A pig is a pal, who'll boost r morale, 
Though mountains may topple and tilt.
When they've blackballed, bamboozled, and burned ,
When they've turned on , Tory and Whig,
Though  may be thrown over by Tabby and Rover,
You'll never go wrong with a pig, a pig,
You'll never go wrong with a pig!
		-- Thomas Pynchon, "Gravity's Rainbow"
What s  think graduate school is supposed to be satisfying?
...
An avocado-tone refrigerator would look good on r resume.
...
"Once more, Strange, and this time *I'll* be Donnie and ** be Marie.
		-- Strange de Jim
By failing to prepare,  are preparing to fail.
One thing they don't tell  about doing experimental physics is that
sometimes  must work under adverse conditions... like a state of sheer
terror.
		-- W.K. Hartmann
...
Paul's Law:
	In America, it's not how much an item costs, it's how much  save.
	...
	"Where did  get this meat?" he bridled hoarsely.
...
You never go anywhere without r soul.
...
then we are a sorry lot indeed.
		-- Albert Einstein
I met a wonderful new man.  He's fictional, but  can't have everything.
...
"Where were  on the night of the 21st?", then flourish a picture of a
scallop or a sole and shout, "Perhaps this will refresh that crude neural
apparatus  call a memory!"  The lobster will squirm noticeably.  It may
even take a swipe at  with one of its claws.  Incorrigible.  Pop it into
the pot.  Justice has been served, and shortly  and r friends will
be, too.
...
"You will be fortunate if  can get him to work for ."
...
"His dissertation is the sort of work  don't expect to see these days;
...
If one studies too zealously, one easily loses his pants.
		-- A. Einstein.
	If  do r best the rest of the way, that takes care of
...
Ever feel like 're the head pin on life's bowling alley, and everyone's
rolling strikes?
...
Why is it that when  DIE,  can't take r HOME ENTERTAINMENT
CENTER with ??
	A ng married couple had their first child.  Their original pride
...
modesty, n.:
	Being comfortable that others will discover r greatness.
...
"One size fits all":
	Doesn't fit anyone.
There's no use in having a dog and doing r own barking.
...
Writing is easy; all  do is sit staring at the blank sheet of paper until
drops of blood form on r forehead.
		-- Gene Fowler
...
And after we were done, to them		A secret, kept from all the rest
	The new proof would be mailed.		Between rself and me.
...
Woody: How are  today, Mr. Peterson?
...
BEFORE  see the TOTAL at the SAFEWAY CHECKOUT COUNTER!
...
is thinking that they're conspiring.
		-- J. Kegler
You are scrulously honest, frank, and straightforward.  Therefore 
have few friends.
...
nef aear, s'i  nef aearon!
		-- J. R. R. Tolkien
Honk if  hate bumper stickers that say "Honk if ..."
...
cattle.  We shall bury him in it."
	...
	"Ah!" sighed Ferdinand Feghoot, shedding a tear, "I fear  do not
realize the full sigance of Pharoah's oxhide!"
		-- Grendel Briarton "Through Time & Space With Ferdinand
		   Feghoot!"
Keep women  cannot.  Marry them and they come to hate the way  walk
across the room; re their lover, and they jilt  at the end of six
months.
		-- Moore
...
he asked, "What's r IQ?"  The new arrival rep, "190".  They
...
question, "What's r IQ?".  Upon receiving the answer "70",
...
as I am absolutely terrified of yams...
	Actually, I think my fear of yams began in my early th, when many
of my ng comrades pelted me with same for singing songs of far-off lands
...
Fellow programmer, greetings!  You are reading a letter which will bring
 luck and good fortune.  Just mail (or UUCP) ten copies of this letter
to ten of r friends.  Before   the copies, send a chip or
other bit of hardware, and 100 lines of 'C' code to the first person on the
list given at the bottom of this letter.  Then delete their name and add
rs to the bottom of the list.
