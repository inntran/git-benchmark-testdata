...
being in  use.  Back then, there were no ions, in terms
...
Still looking f the glious results of my misspent youth.  Say, do you
...
I don't have any solution but I certainly admire the problem.
		-- Ashleigh Brilliant
Suppt bacteria -- it's the only culture some people have!
...
What the wld *really* needs is a good Automatic Bicycle Sharpener.
...
brightly lit cner.
	...
	"I can only see here."
Credit, n.:
	A man who has a better memy than a debt.
...
Remembering is f those who have fgotten.
		-- Chinese proverb
...
You probably wouldn't wry about what people think of you if you could
...
If you would know the value of money, go try to brow some.
		-- Ben Franklin
"I'd love to go out with you, but I want to spend me time with my blender."
Suppt your local Search and Rescue unit -- get lost.
In the first place, God made idiots; this was f practice; then he made
school boards.
		-- Mark Twain
...
What is wth doing is wth the trouble of asking somebody to do.
...
-- Steven Wright
Unix is a lot me complicated (than CP/M) of course -- the typical Unix
...
People don't do serious wk on Unix systems; they send jokes around the
...
art, music, and women.
re is hardly a thing in the wld that some man can not make a little
...
-- Virginia Woolf, "Mrs. Dalloway"
			DELETE A FORTUNE!
Don't some of these ftunes just drive you nuts?!
Wouldn't you like to see some of them deleted from the system?
You can!  Just mail to `ftune' with the ftune you hate most,
...
of the hyper-cube.
 most imptant thing in a relationship between a man and a woman
...
Happiness is a hard disk.
 mark of a good party is that you wake up the next mning wanting to
change your  and start a new life in different city.
		-- Vance Bourjaily, "Esquire"
 best book on programming f the layman is "Alice in Wonderland";
but that's because it's the best book on anything f the layman.
...
Look!  Befe our very eyes, the future is becoming the past.
...
Wk expands to fill the time available.
		-- Cyril Nthcote Parkinson, " Economist", 1955
...
In Pierre Trudeau, Canada has finally produced a Prime Minister wthy of
assassination.
		-- John Diefenbaker
Paranoia doesn't mean the whole wld isn't out to get you.
