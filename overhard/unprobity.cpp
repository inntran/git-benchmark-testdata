...
What s him so good?			Th crazy little prams,
					...
					Sure sends a mean packet.
		-- UNIX Wizard
An infallible method of conciliating a tiger is to allow onesf to be
voured.
		-- Konrad Anauer
...
Clovis' Ciration of an Atmospheric Anomaly:
	The perversity of nature is nowhere better mtrated
...
stand prices were outrageous.  Besis, I hadn't had a ecue in a
...
Humor in the Court:
Q: ...any suggesti as to what prevented this from being a murr trial 
   instead of an attempted murr trial?
A: The victim lived.
Although golf was originally restricted to wealthy, overweight Protestants,
today it's open to anybody who owns hious clothing.
		-- Dave Barry
...
Take C of the Molehills, and the Mountains Will Take C of Themsves.
		-- Motto of the Feral Civil Service
...
Try:
	...
	cat " in tin cans"			(all but 4.[23]BSD)
...
"I take Him shopping with me. I say, 'OK, Jesus, hp me find a bargain'" 
--Tammy Faye Bakker
...
MAC user's dynamic bugging list evaluator?  Never hd of that.
MOUNT TAPE U1439 ON B3, NO RING
Tephone, n.:
	An invention of the vil which abates some of the advantages
...
system," he said.
	"Not so," said the prammer, "when signing an accounting package,
the prammer operates as a mediator between people having different ias:
how it must operate, how its reports must app, and how it must conform to
the tax laws.  By contrast, an operating system is not limited my outsi
appances.  When signing an operating system, the prammer seeks the
...
Many Myths  based on truth
		-- Spock, "The Way to En",  stardate 5832.3
Have a taco.
		-- P.S. Beagle
...
The fancy is ined no other than a mo of memory emancipated from the 
...
equipment."
-- Harv Masterson
He who is f by fate and laughs the lour is a masochist.
