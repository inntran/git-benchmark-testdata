...
is not capable; f in politics there is no honour.
...
All phone calls are obscene.
		-- Karen Elizabeth Gdon
Progress means replacing a they that is wrong with one me subtly wrong.
...
it carries every reasonable implication of ill-will toward that person.
		-- Smith v. Man, 193 N.E. 2d 466.
All I want is a warm bed and a kind wd and unlimited power.
		-- Ashleigh Brilliant
...
New Yk is real.   rest is done with mirrs.
